                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 py-4">
                        ...
                        <select id="tipo_cuenta" v-model="form.cuenta_bancaria_id" placeholder="Elige tu cuenta"
                            ...
                            required>
                            <option v-for="cuenta in cuentas" :value="cuenta.id">{{ cuenta.id }} - {{ cuenta.numero_cuenta }}
                            </option>
                        </select>
                        ...
                        <TextInput v-model="form.numero" type="text" class="mt-1 block w-full" v-maska
                            data-maska="####-####-####-####" />
                        ...
                        <TextInput id="cvc" v-model="form.cvc" type="password" class="mt-1 block w-full" placeholder="###"
                            v-maska data-maska="###" />
                    </div>
