...
<template>
                ...
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        ...
                        <!-- <ApplicationLogo
                                    ...
                                    /> -->
                        <img src="../../static/nuevoLogo.svg" alt="logo" class="h-[120px]">
                        </Link>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <NavLink :href="route('cuentas-bancarias')" :active="route().current('cuentas-bancarias')">
                            Cuentas Bancarias
                        </NavLink>
                        <NavLink :href="route('transacciones')" :active="route().current('transacciones')">
                            Transacciones
                        </NavLink>
    ...
    <!-- Page Heading -->
    <header class="bg-sky-200 shadow" v-if="$slots.header">
