<template>
    ...
    <div class="w-screen h-screen flex items-center justify-center bg-white" id="fondo_blur">
        <div>
            <form @submit.prevent="submit" class="shadow-xl bg-[#d8eefe] rounded-xl h-auto p-10">
                <h1 class="text-bold text-5xl leading-10 text-left">Antes de continuar, necesitamos unos datos más.</h1>
                ...
                <TextInput id="numero_cuenta" type="text" class="mt-1 block w-full" v-model="form.numero_cuenta" required
                    v-maska placeholder="ES##..." data-maska="ES##-####-####-##-##########" />
                <label for="monto">Ingresa el saldo de tu cuenta (solo para demo):</label>
                <TextInput id="monto" type="number" class="mt-1 block w-full" v-model="form.monto" required placeholder="50.000€" v-maska="'#*.##'"/>
                <div class="flex mt-4 file:gap-2 text-right">
                    <PrimaryButton type="submit" class="shadow-2xl">Continuar</PrimaryButton>
                </div>
...
<script setup>
import Boton from '../Components/nuestros/Boton.vue'
...
<style>
#fondo_blur{
    background-image: url('../../static/blur3.jpg');
